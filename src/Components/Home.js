...
<div className="welcomeInfo">
  ...
  <div className="welcomeInfo">
    ...
    <p>For years, women have strived to be included in big wave competitions, while organizers argued that heavy waves like the notorious Mavericks or Jaws are just too dangerous for chicks. It’s a man’s world, but there are some ladies out there that are proving themselves fit to take over the stage and kick some ass!</p>
  </div>
